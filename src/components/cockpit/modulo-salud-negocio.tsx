  ...
  return (
    <div className="grid grid-cols-12 items-center gap-2 border-b border-zinc-950/[0.05] py-2.5 text-[12px] last:border-0 dark:border-white/[0.05]">
      <Link
        ...
        className="col-span-12 min-w-0 truncate font-medium text-zinc-800 hover:opacity-70 sm:col-span-3 dark:text-zinc-100"
        title={o.nombre}
      >
        {o.nombre}
      </Link>
...
function MoneyInput({
  ...
  return (
    <div className="flex items-center rounded-none border border-zinc-300 bg-white px-2.5 py-1.5 focus-within:border-zinc-900 dark:border-white/15 dark:bg-white/[0.04] dark:focus-within:border-white">
            ...
            {salud.finalizadas.length > 0 && (
              <div className="mt-3">
                <button
                  ...
                  className="text-[11px] text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-50"
                >
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-[11px] font-medium text-zinc-900 hover:opacity-70 dark:text-zinc-50"
                >
                  + Retiro
                </button>
              </div>
              ...
              <div className="mt-3 grid grid-cols-2 gap-3">
                <div className="rounded-none border border-zinc-900/[0.08] bg-zinc-100/70 px-3 py-2.5 dark:border-white/[0.08] dark:bg-white/[0.04]">
              ...
              {retiroOpen && (
                <div className="mt-3 space-y-2 rounded-none border border-zinc-200 p-3 dark:border-white/10">
                  <div className="flex gap-2">
                    <button
                      type="button"
                      onClick={() => setRTipo("retiro")}
                      className={`flex-1 rounded-none px-2 py-1.5 text-[12px] font-medium ${rTipo === "retiro" ? "bg-zinc-900 text-white dark:bg-white dark:text-zinc-900" : "bg-zinc-100 text-zinc-600 dark:bg-white/[0.06] dark:text-zinc-300"}`}
                    >
                      Retiro (saco)
                    </button>
                    <button
                      ...
                      className={`flex-1 rounded-none px-2 py-1.5 text-[12px] font-medium ${rTipo === "aporte" ? "bg-zinc-900 text-white dark:bg-white dark:text-zinc-900" : "bg-zinc-100 text-zinc-600 dark:bg-white/[0.06] dark:text-zinc-300"}`}
                    >
                      Aporte (pongo)
                    </button>
                  </div>
                  ...
                  <input
                    ...
                    className="w-full rounded-none border border-zinc-300 bg-white px-2.5 py-1.5 text-[13px] text-zinc-900 outline-none focus:border-zinc-900 dark:border-white/15 dark:bg-white/[0.04] dark:text-zinc-50 dark:focus:border-white"
                  />
                  <button
                    type="button"
                    disabled={guardando || parseFormattedNumber(rMonto) <= 0}
                    onClick={guardarRetiro}
                    className="w-full rounded-none bg-zinc-900 py-1.5 text-[13px] font-semibold text-white hover:bg-zinc-700 disabled:opacity-40 dark:bg-white dark:text-zinc-900 dark:hover:bg-zinc-200"
                  >
