...
// que lleguen acá. Este POST multipart quedó como fallback chico (curl del
// motor, scripts): la UI sube por el flujo DIRECTO a Supabase Storage
// (archivos/firmar + archivos/confirmar, techo 25 MB) y no pasa por acá.
