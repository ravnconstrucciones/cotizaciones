                        ...
                        {p.presupuesto_aprobado ? (
                          ...
                          <div className="mt-3 flex flex-col gap-2">
                            <Link
                              ...
                              className="cdm-btn-cian inline-flex w-full max-w-xs items-center justify-center rounded-none px-5 py-3 text-center text-xs font-semibold uppercase tracking-wider sm:w-auto"
                            >
