...
const PORCELAIN_TILE: ItemDesglose = {
  ...
  precios: {
    ...
    retail: {
      valor: 33_000,
      fuente: "Retail de referencia · porcelanato rectificado 60 × 60",
      fecha: "2026-08-15",
    },
  },
  precio_min: 28_000,
...
const TILE_ADHESIVE: ItemDesglose = {
  ...
  precios: {
    ...
    internet: {
      valor: 27_000,
      fuente: "Corralón zona norte · adhesivo flexible porcelanato 30 kg",
      fecha: "2026-08-15",
    },
    retail: {
      valor: 26_000,
      fuente: "Retail de referencia · adhesivo flexible porcelanato",
      fecha: "2026-08-15",
    },
  },
  precio_min: 20_500,
